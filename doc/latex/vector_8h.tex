\hypertarget{vector_8h}{\section{minimu/vector.h \-File \-Reference}
\label{vector_8h}\index{minimu/vector.\-h@{minimu/vector.\-h}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=308pt]{vector_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{\-Typedefs}
